...
from ids_ml.specs import (
    expected_configuration_keys,
    specs_for_round,
    validate_round_filter,
)
from ids_ml.workflows import _filter_specs, partition_specs_for_execution
from ids_ml.workflows import (
    baseline_main,
    neural_main,
    show_results_main,
    tree_main,
...
def test_pyproject_exposes_the_expected_commands() -> None:
    ...
    assert configuration["project"]["scripts"] == {
        "ids-run-baselines": "ids_ml.workflows:baseline_main",
